            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                    <ul id="sidebarnav">
                            ...
                            <div class="user-profile d-flex dropdown mt-3">
                                ...
                                <div class="user-content hide-menu ms-2">
                                    ...
                                    <div
                                        ...
                                        <a
                                            class="dropdown-item d-flex border-bottom border-top mt-1 py-3"
                                            href="javascript:void(0)">
                                            <iconify-icon
                                        ...
                                        <a
                                            class="dropdown-item d-flex py-3 pb-2"
                                            href="javascript:void(0)">
                                            <iconify-icon
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow" href="#" id="get-url">
                                <iconify-icon
                                    icon="solar:screencast-2-linear"
                                    class="fs-5"></iconify-icon>
                ...
                <div class="with-vertical">
                    ...
                    <nav class="navbar navbar-expand-lg px-lg-0 px-0 py-0">
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li
                                class="nav-item d-none d-lg-flex search-box nav-icon-hover-bg rounded-circle">
                                <a
                                    class="nav-link"
                                    href="javascript:void(0)"
                                            ...
                                            <div class="col-8">
                                                <div class="ps-7 pt-7">
                                                                ...
                                                                <div class="position-relative">
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">New messages arrived</span>
                                                                        </div>
                                                                    </a>
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">Get latest invoice</span>
                                                                        </div>
                                                                    </a>
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">2 Unsaved Contacts</span>
                                                                        </div>
                                                                    </a>
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">Get new emails</span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="position-relative">
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">learn more information</span>
                                                                        </div>
                                                                    </a>
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">Get dates</span>
                                                                        </div>
                                                                    </a>
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">Add new contact</span>
                                                                        </div>
                                                                    </a>
                                                                    <a
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">To-do and Daily tasks</span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row align-items-center py-3">
                                                        <div class="col-8">
                                                            <a
                                                                class="fw-semibold d-flex align-items-center lh-1"
                                                                href="javascript:void(0)">
                                                ...
                                                <div class="position-relative p-7 border-start h-100">
                                                    ...
                                                    <ul class="">
                                                        ...
                                                        <li class="mb-3">
                                                            <a
                                                                class="fw-semibold bg-hover-primary"
                                                                href="../main/authentication-login.html">Authentication Design</a>
                                                        </li>
                                                        <li class="mb-3">
                                                            <a
                                                                class="fw-semibold bg-hover-primary"
                        ...
                        <a
                            class="navbar-toggler nav-icon-hover-bg rounded-circle p-0 border-0 text-white"
                            href="javascript:void(0)"
                            data-bs-toggle="collapse"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <ul class="navbar-nav flex-row d-flex d-lg-none">
                                    <li
                                        class="nav-item dropdown mega-dropdown nav-icon-hover-bg rounded-circle">
                                        <a
                                            class="nav-link"
                                            id="drop2"
                                            href="javascript:void(0)"
                                    ...
                                    <li
                                        class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                                        <a
                                            href="javascript:void(0)"
                                            ...
                                            <iconify-icon
                                                icon="solar:menu-dots-circle-linear"></iconify-icon>
                                        </a>
                                    </li>
                                </ul>
                                <ul
                                    ...
                                    <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                                        ...
                                        <div
                                            class="dropdown-menu content-dd mailbox dropdown-menu-end dropdown-menu-animate-up"
                                            aria-labelledby="drop2">
                                            <div
                                            ...
                                            <div class="message-body" data-simplebar>
                                                ...
                                                <a
                                                    ...
                                                    <div class="w-75">
                                                        ...
                                                        <span class="d-block text-truncate text-truncate">You can customize this template as you
                                                            want</span>
                                                    </div>
                                                </a>
                                                <a
                                            ...
                                            <div>
                                                <a
                                                    class="d-flex align-items-center pt-3 pb-2 justify-content-center h6 mb-0"
                                                    href="javascript:void(0);">
                                    ...
                                    <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                                        <a
                                            ...
                                            aria-expanded="false">
                                            <iconify-icon
                                                icon="solar:chat-line-outline"></iconify-icon>
                                            <div class="notify">
                                                <span class="heartbit"></span>
                                                <span class="point"></span>
                                            </div>
                                        ...
                                        <div
                                            class="dropdown-menu message-box content-dd mailbox dropdown-menu-end dropdown-menu-animate-up"
                                            aria-labelledby="drop2">
                                            <div
                                                class="d-flex border-bottom align-items-center justify-content-between py-3 px-4">
                                            ...
                                            <div class="message-body" data-simplebar>
                                                ...
                                                <a
                                                    ...
                                                    <span
                                                        class="user-img position-relative d-inline-block">
                                                        <img
                                                            src="{{asset('assets/images/profile/user-6.jpg')}}"
                                                            alt="user"
                                                            class="rounded-circle w-100 round" />
                                                        <span
                                                            class="profile-status bg-success position-absolute rounded-circle"></span>
                                                ...
                                                <a
                                                    ...
                                                    <span
                                                        class="user-img position-relative d-inline-block">
                                                        <img
                                                            src="{{asset('assets/images/profile/user-7.jpg')}}"
                                                            alt="user"
                                                            class="rounded-circle w-100 round" />
                                                        <span
                                                            class="profile-status bg-success position-absolute rounded-circle"></span>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div
                                            class="dropdown-menu message-box pt-0 content-dd mailbox dropdown-menu-end dropdown-menu-animate-up"
                                            aria-labelledby="drop2">
                                            <div
                                ...
                                <ul id="sidebarnav">
                                    <li class="sidebar-item">
                                        <a
                                            ...
                                            <span>
                                                <iconify-icon
                                                    icon="solar:shield-plus-outline"
                                        ...
                                        <ul
                                            aria-expanded="false"
                                            class="collapse first-level my-3">
                            ...
                            <div
                                ...
                                <ul
                                    ...
                                    <li
                                        ...
                                        <div
                                            class="dropdown-menu pt-0 content-dd mailbox dropdown-menu-end dropdown-menu-animate-up"
                                            aria-labelledby="drop2">
                                            <div
                                                class="d-flex border-bottom align-items-center justify-content-between py-3 px-4">
                                                <div class="mb-0 fs-4 fw-medium h6">
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                <a
                                    ...
                                    <span class="d-flex">
                                        <iconify-icon
                                            icon="solar:screencast-2-outline"
                                            class="fs-6"></iconify-icon>
                                    </span>
                                    <span class="hide-menu">Dashboard</span>
                                </a>
