...
<head>
    ...
    <title>Login Basic - Pages | Stumak - Bootstrap Admin Template</title>
...
<body>
    ...
    <noscript><iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-5J3LMKC" height="0"
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-6">
                            <a href="index.html" class="app-brand-link">
                                ...
                                <span
                                    class="app-brand-text demo text-heading fw-bold">Stumak</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1">Welcome to Stumak! 👋</h4>
                        <p class="mb-6">Please sign-in to your account and start the
                            adventure</p>

                        <form id="formAuthentication" class="mb-4"
                            action="https://demos.pixinvent.com/Stu,mak-html-admin-template/html/vertical-menu-template/index.html"
                            method="GET">
                            <div class="mb-6">
...
<!-- Mirrored from demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 11:19:18 GMT -->
